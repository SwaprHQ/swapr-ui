...
const SvgEyeHide = ({ ...props }) => /* @__PURE__ */ jsxRuntime.jsxs(
  "svg",
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx("path", { fill: "currentColor", d: "M14.265 13.99a3 3 0 0 1-.268.268z" }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "path",
        {
          fill: "currentColor",
...
module.exports = SvgEyeHide;
//# sourceMappingURL=EyeHide.cjs.map
